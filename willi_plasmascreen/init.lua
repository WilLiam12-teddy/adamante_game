...
minetest.register_node("willi_plasmascreen:stand", {
...
minetest.register_alias("willi_plasmascreen:screen1", "air")
minetest.register_alias("willi_plasmascreen:screen2", "air")
minetest.register_alias("willi_plasmascreen:screen3", "air")
minetest.register_alias("willi_plasmascreen:screen4", "air")
minetest.register_alias("willi_plasmascreen:screen5", "willi_plasmascreen:tv")
minetest.register_alias("willi_plasmascreen:screen6", "air")
...
minetest.register_node("willi_plasmascreen:tv", {
	...
	on_rightclick = function(pos, node, clicker, itemstack, pointed_thing)
		minetest.set_node(pos, {name = "willi_plasmascreen:tv_off", param2 = node.param2})
	end
})

minetest.register_node("willi_plasmascreen:tv_off", {
	...
	on_rightclick = function(pos, node, clicker, itemstack, pointed_thing)
		minetest.set_node(pos, {name = "willi_plasmascreen:tv", param2 = node.param2})
	end,
	drop = "willi_plasmascreen:tv"
})
