...
minetest.register_node("cherrytree:sapling", {
	description = S("Muda de Cerejeira"),
	drawtype = "plantlike",
	visual_scale = 1.0,
...
minetest.register_node("cherrytree:trunk", {
	description = S("Tronco de Cerejeira"),
	tiles = {
...
minetest.register_node("cherrytree:wood", {
	description = S("Madeira de Cerejeira"),
...
minetest.register_node("cherrytree:blossom_leaves", {
	description = S("Folhas de cerejeira"),
...
minetest.register_node("cherrytree:leaves", {
	description = S("Folhas de Arvore de Cerejeira"),
	drawtype = "allfaces_optional",
	visual_scale = 1.2,
