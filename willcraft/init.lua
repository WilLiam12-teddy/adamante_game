...
minetest.register_node("willcraft:brick", {
    description = "Brick Block - build with that!.",
    tiles = {"brick.png"},
    is_ground_content = true,
    groups = {cracky=3, stone=1}
})

minetest.register_node("willcraft:aspen", {
    description = "Aspen Wood - lol, a new aspen wood.",
    tiles = {"aspen.png"},
    is_ground_content = true,
    groups = {choppy=2}
})

minetest.register_node("willcraft:blue_wool", {
    description = "A Blue Wool - build?",
    tiles = {"blue_wool.png"},
    is_ground_content = true,
