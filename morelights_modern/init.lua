minetest.register_node("morelights_modern:block", {
  description = "Bloco de Luz Moderno",
...
minetest.register_node("morelights_modern:smallblock", {
  description = "Bloco de Luz Moderno (pequeno)",
  drawtype = "nodebox",
  node_box = {
    type = "fixed",
...
minetest.register_node("morelights_modern:barlight_c", {
  description = "Luz da barra do teto (conectando)",
  drawtype = "nodebox",
  node_box = {
    type = "connected",
...
minetest.register_node("morelights_modern:barlight_s", {
  description = "Luz da barra do teto",
  drawtype = "nodebox",
  node_box = {
    type = "fixed",
...
minetest.register_node("morelights_modern:ceilinglight", {
  description = "Luz moderna de teto",
  drawtype = "nodebox",
  node_box = {
    type = "fixed",
