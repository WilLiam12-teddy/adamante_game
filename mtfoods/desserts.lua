...
minetest.register_craftitem("mtfoods:dandelion_milk", {
	description = "Leite Dente-de-leao",
...
minetest.register_craftitem("mtfoods:chocolate", {
	description = "pedacos de chocolate",
...
--	description = "Torta cremosa de Banana",
