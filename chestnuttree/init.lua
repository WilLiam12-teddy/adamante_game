...
minetest.register_node("chestnuttree:bur", {
	description = S("broca de castanheiro"),
	drawtype = "plantlike",
...
minetest.register_node("chestnuttree:sapling", {
	description = S("Muda de Castanheira"),
	drawtype = "plantlike",
	visual_scale = 1.0,
...
minetest.register_node("chestnuttree:trunk", {
	description = S("Tronco de Castanheira"),
	tiles = {
...
minetest.register_node("chestnuttree:wood", {
	description = S("Madeira de Castanheira"),
...
minetest.register_node("chestnuttree:leaves", {
	description = S("Folhas de Castanheira"),
