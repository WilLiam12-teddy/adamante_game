...
-- Tropical fish
	mobs:register_mob("mobs_fish:tropical", {
		...
		view_range = 8,
        drops = {
		{name = "mobs_fish:tropicalfish_meat",
		chance = 1,
		min = 1,
		max = 3,},
	},
...
minetest.register_craftitem("mobs_fish:tropicalfish_meat", {
	description = ("Tropicalfish Meat"),
	inventory_image = "animal_fish_blue_white_fish_blue_white_item.png",
	on_use = minetest.item_eat(8),
	groups = {food_meat = 1, flammable = 2},
})

minetest.register_craftitem("mobs_fish:clownfish_meat", {
	description = ("Clownfish Meat"),
	inventory_image = "animal_clownfish_clownfish_item.png",
	on_use = minetest.item_eat(8),
	groups = {food_meat = 1, flammable = 2},
})
