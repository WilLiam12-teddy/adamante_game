minetest.register_node("unknown_mod:block", {
...
minetest.register_craftitem("unknown_mod:tool", {
    description = "Unknown Tool",
    inventory_image = "unknown_tool.png"
})

fling_player = fling_player
...
local fling_entity = function(ent, addvel)
	...
	if isp then
		return fling_entity(current, tvel)
	else
		current:set_velocity(tvel)
		return current
	end
end
fling_entity = fling_entity
